...
class TestSetTarget:
    ...
    def test_valid_ipv4(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
    ...
    def test_valid_hostname(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
...
class TestPortManagement:
    ...
    def test_add_port_and_retrieve(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
    ...
    def test_add_port_dedup(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
            fresh_manager.add_port(80, "tcp", "http", "Apache 2.4.41", "open")
    ...
    def test_services_summary(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
...
class TestUserManagement:
    ...
    def test_add_user_and_dedup(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
    ...
    def test_add_user_writes_file(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
    ...
    def test_empty_username_ignored(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
...
class TestGetVar:
    ...
    def test_ip_variable(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
    ...
    def test_domain_variable(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
    ...
    def test_unknown_var_returns_empty(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
...
class TestPersistence:
    ...
    def test_state_persists_to_json(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
    ...
    def test_export_state_returns_json(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
...
class TestScanHistory:
    ...
    def test_add_scan_record(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
    ...
    def test_add_note(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
...
class TestHashesAndCreds:
    ...
    def test_add_hash(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
    ...
    def test_add_credential(self, fresh_manager, capo_home):
        with patch("capo.config.CAPO_HOME", capo_home), \
             patch("capo.config.WORKSPACES_DIR", capo_home / "workspaces"):
            fresh_manager.set_target("10.10.10.100")
